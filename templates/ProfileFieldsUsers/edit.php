...
<li><?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $profileFieldsUser->id], ['confirm' => __('Are you sure you want to delete # {0}?', $profileFieldsUser->id), 'class' => 'nav-link']) ?></li>
...
<div class="profileFieldsUsers form content">
    ...
    <fieldset>
        <legend><?= __('Edit Profile Fields User') ?></legend>
        <?php
